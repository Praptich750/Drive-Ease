    ...
    <div className='px-4 py-10 md:px-10 flex-1'>
       ...
       <form onSubmit={onSubmitHandler} className='flex flex-col gap-5 text-gray-500 text-sm mt-6 max-w-xl'>
        ...
        <div className='grid grid-cols-1 sm:grid-cols-2 md:grid-cols-3 gap-6'>
         ...
         {/** Car Transmission, fuel, seating capacity */}
         ...
         {/** Car Location */}
          ...
          <div className='flex flex-col w-full'>
            ...
            <textarea rows={5} placeholder='e.g. A luxurious SUV with a spacious interior and a powerfull engine' required className='px-3 py-2 mt-1 border border-borderColor rounded-md outline-none' value={car.description || ""} onChange={e=> setCar({...car, description: e.target.value})}/>
          </div>
